...
const BASE_SCOPES: DiscoveryScope[] = [
  {
    category: "home-care",
    queries: [
      "생활가전 문제 해결", "집안 가전 불편", "가전 관리 고민", "집 관리 문제", "생활기기 오류",
      "집 청소 불편", "생활용품 관리 문제", "가전 소음 냄새", "집안 습기 보관", "생활용품 버리는 법",
    ],
  ...
  },
  {
    ...
    queries: [
      "스마트폰 사용 문제", "앱 설정 오류", "디지털 생활 불편", "휴대폰 데이터 문제", "컴퓨터 사용 고민",
      "스마트폰 저장공간 문제", "사진 파일 정리 문제", "PC 설정 불편", "앱 데이터 백업", "온라인 계정 설정 문제",
    ],
  ...
  },
  {
    ...
    queries: [
      "대형폐기물 신청", "주민센터 서류 발급", "공공시설 이용 방법", "이사 생활 서비스", "주소 변경 생활 절차",
      "폐가전 버리는 법", "생활 폐기물 배출", "공공서비스 신청 방법", "생활 서류 온라인 발급", "이사 후 생활 절차",
    ],
  ...
  },
  {
    ...
    queries: [
      "집 정리 보관 고민", "생활용품 정리 문제", "주방 정리 보관", "옷 정리 보관", "공간 정리 불편",
      "식품 보관 고민", "계절용품 보관", "수납 공간 부족", "옷장 습기 정리", "주방 수납 불편",
    ],
...
const STRONG_THEME_WORDS = [
  ...
  "백업", "동기화", "폐기", "수납", "습기", "결로", "설치", "알림", "파일", "와이파이",
];

const ENTITY_WORDS = [
  "에어컨", "공기청정기", "세탁기", "건조기", "냉장고", "가습기", "보일러", "전자레인지", "도어락",
  "노트북", "스마트폰", "휴대폰", "아이폰", "갤럭시", "컴퓨터", "데스크탑", "PC", "인스타그램", "카카오톡", "구글", "윈도우", "맥북",
  "매트리스", "소파", "옷", "이불", "쌀", "잡곡", "택배", "대형폐기물", "폐가전", "쓰레기",
];
